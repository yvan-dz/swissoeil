        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Nos Docteurs</h1>
                    <div class="nav-bread-crumb">
                        <a href="#">Acceuil</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Nos Docteurs</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-center">
                        <span class="pre">Nos Docteurs</span>
                        <h2 class="title text-center">Découvrez Nos<br> Docteurs experts </h2>
                    </div>
                </div>
            </div>
            <div class="row g-5 mt--20 meet-doctor-area-sd">
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".2s"
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".4s"
                    data-wow-duration=".8s">
                    <div class="single-team-area-start">
                        <a href="doctor-details.html" class="thumbnail">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".6s"
                    data-wow-duration=".8s">
                    <div class="single-team-area-start">
                        <a href="doctor-details.html" class="thumbnail">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".8s"
                    data-wow-duration=".8s">
                    <div class="single-team-area-start">
                        <a href="doctor-details.html" class="thumbnail">
